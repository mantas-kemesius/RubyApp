...
class User < ActiveRecord::Base
  ...
  validates_uniqueness_of :username, message: "your username should be unique"
  ...
  validates_length_of :username, maximum: 30, message: "username maximum length 40 characters"
