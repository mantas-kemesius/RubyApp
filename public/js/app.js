    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/register', component: _Registerpage2.default })
            );
        }
    }]);
...
var _Component3 = __webpack_require__(101);

var _Component4 = __webpack_require__(102);

var _Component5 = __webpack_require__(103);
...
var Homepage = function (_React$Component) {
    ...
    _createClass(Homepage, [{
        ...
        value: function render() {
            ...
            if (currentUser !== null) {
                bodyContent = currentUser.role === 'ROLE_STUDENT' ? _react2.default.createElement(_Component3.StudentBody, null) : _react2.default.createElement(_Component4.TeacherBody, null);
            } else bodyContent = _react2.default.createElement(_Component5.WelcomeBody, null);
...
var HeaderMenu = exports.HeaderMenu = function (_React$Component) {
    ...
    _createClass(HeaderMenu, [{
        ...
        value: function render() {
            ...
            var menu = void 0;
            if (currentUser !== null) {
                var loggedIn = !!currentUser.loggedIn || false;
                if (!loggedIn) {
                    ...
                    menu = React.createElement(
                        ...
                        React.createElement(
                            _reactRouterDom.Link,
                            { to: '/logout' },
                            React.createElement(_Component2.default, { id: 1, name: "Atsijungti" })
                        )
                    );
                }
            } else {
    ...
    function RegisterForm(props) {
        ...
        _this.handleClick = function () {
            if (_this.state.name !== "" && _this.state.last_name !== "" && _this.state.email !== "" && _this.state.password !== "" && Number.isInteger(parseInt(_this.state.age))) {
                var user = _extends({}, _this.state);
                _axios2.default.post('http://0.0.0.0:3000/user/create', { user: user }).then(function (res) {
    ...
    _createClass(RegisterForm, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'text', placeholder: 'Vardas', className: 'input input-text', value: this.state.name, onChange: function onChange(e) {
                        return _this2.handleName(e);
                    } }),
                _react2.default.createElement('input', { type: 'text', placeholder: 'Pavard\u0117', className: 'input input-text', value: this.state.last_name, onChange: function onChange(e) {
                        return _this2.handleLastname(e);
                    } }),
                _react2.default.createElement('input', { type: 'text', placeholder: 'Am\u017Eius', className: 'input input-text', value: this.state.age, onChange: function onChange(e) {
                        return _this2.handleAge(e);
                    } }),
                _react2.default.createElement('input', { type: 'password', placeholder: 'Slapta\u017Eodis', className: 'input input-text', value: this.state.password, onChange: function onChange(e) {
                        return _this2.handlePassword(e);
                    } }),
...
var _Component3 = __webpack_require__(71);
...
var _Component3 = __webpack_require__(72);
...
var WelcomeBody = exports.WelcomeBody = function (_React$Component) {
    _inherits(WelcomeBody, _React$Component);

    function WelcomeBody() {
        _classCallCheck(this, WelcomeBody);

        return _possibleConstructorReturn(this, (WelcomeBody.__proto__ || Object.getPrototypeOf(WelcomeBody)).apply(this, arguments));
    }

    _createClass(WelcomeBody, [{
        key: "render",
        value: function render() {
            return React.createElement(
                "div",
                { className: "WelcomeBody home-body" },
                React.createElement(
                    "div",
                    { className: "WelcomeBody-container" },
                    React.createElement(
                        "h1",
                        null,
                        "Sveiki atvyk\u0119 \u012F pagalbin\u0119 universiteto svetain\u0119."
                    ),
                    React.createElement(
                        "h2",
                        null,
                        "Kvie\u010Diame jus u\u017Esiregistruoti \uD83D\uDC4D\uD83E\uDD18\uD83D\uDC4C!"
                    )
                )
            );
        }
